...
SUDO = SUDO
sudo_users = {SUDO,1619524486,1767874645}   
print([[
┏┓━━━━━━━━━━━┏┓━━━━━━━━
┃┃━━━━━━━━━━━┃┃━━━━━━━━
┃┗━┓┏━━┓┏┓━┏┓┃┃┏┓┏━━┓         
...
io.popen("cd library && wget https://raw.githubusercontent.com/FAWAZ5265/FAWAZ/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FAWAZ5265/Files_FAWAZ/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevFAWAZW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevFAWAZW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevFAWAZW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevFAWAZW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevFAWAZW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevFAWAZW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevFAWAZW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1767874645) then
var = true  
...
local UserName = (data.username_ or "SOURCE_FAWAZ")
...
local FAWAZ_Msg = ''  
if msgs < 100 then 
FAWAZ_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
FAWAZ_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
FAWAZ_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
FAWAZ_Msg = 'متفاعل' 
elseif msgs < 1200 then 
FAWAZ_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
FAWAZ_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
FAWAZ_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
FAWAZ_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
FAWAZ_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
FAWAZ_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
FAWAZ_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
FAWAZ_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
FAWAZ_Msg = 'رب التفاعل'  
end 
return FAWAZ_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceFAWAZ(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if DevFAWAZW(msg) then
local bl = ' *⇜اهلا عزيزي آلمـطـور*\n*⇜آنت آلمـطـور آلآسـآسـي للبوت*\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n*⇜تسـتطـيع‌‏ آلتحگم باوامر البوت*\n*⇜من خلاال الكيبورت خاص بك*\n*⇜قناة سورس البوت *[اضغط هنا](t.me/SOURCE_FAWAZ)'
local keyboard = {
...
local list = database:smembers(bot_id.."FAWAZ1:List:Filter"..sl)
...
if not DevFAWAZW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevFAWAZW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,FAWAZ_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⇜' and DevFAWAZW(msg) then  
...
if text == 'تعطيل التواصل ⇜' and DevFAWAZW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⇜' and DevFAWAZW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⇜' and DevFAWAZW(msg) then  
...
if text == 'ضع كليشه ستارت ⇜' and DevFAWAZW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⇜ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⇜' and DevFAWAZW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⇜تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⇜' and DevFAWAZW(msg) then 
...
if text == 'تحديث السورس ⇜' and DevFAWAZW(msg) then 
os.execute('rm -rf FAWAZ.lua')
os.execute('wget https://raw.githubusercontent.com/FAWAZ5265/FAWAZ/main/FAWAZ.lua')
send(msg.chat_id_, msg.id_,' *⇜تم تحديث السورس* \n*⇜لديك اخر اصدار لسورس بويكا*\n*⇜الاصدار » { 2.8v}*')
dofile('FAWAZ.lua')  
end
if text == 'الاصدار ⇜' and DevFAWAZW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⇜اصدار سورس بويكا* \n*⇜الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⇜' and DevFAWAZW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⇜[تحديثات البوت](t.me/wtttw) \n⇜[قناه السورس](t.me/SOURCE_FAWAZ)')
end
if text == "ضع اسم للبوت ⇜" and DevFAWAZW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⇜ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⇜' and DevFAWAZW(msg) then 
...
if text == 'المشتركين ⇜' and DevFAWAZW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⇜المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'القروبات ⇜' and DevFAWAZW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⇜القروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⇜") and DevFAWAZW(msg) then
...
if text == ("قائمه العام ⇜") and DevFAWAZW(msg) then
...
if text == ("قائمه الكتم العام ⇜") and DevFAWAZW(msg) then
...
if text=="اذاعه خاص ⇜" and msg.reply_to_message_id_ == 0 and DevFAWAZW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⇜ارسل الان اذاعتك؟* \n*⇜للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⇜" and msg.reply_to_message_id_ == 0 and DevFAWAZW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⇜ارسل الان اذاعتك؟* \n*⇜للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⇜" and msg.reply_to_message_id_ == 0 and DevFAWAZW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⇜ارسل الان اذاعتك؟* \n*⇜للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⇜" and msg.reply_to_message_id_ == 0  and DevFAWAZW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⇜ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⇜" and msg.reply_to_message_id_ == 0  and DevFAWAZW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⇜ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⇜' and DevFAWAZW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⇜" and DevFAWAZW(msg) then
...
if text == "تنظيف القروبات ⇜" and DevFAWAZW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⇜عدد القروبات الان » { '..#group..' }'..FAWAZk..''..FAWAZ..'*\n*⇜الان عدد القروبات الحقيقي » { '..sendok..' } قروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevFAWAZW(msg) then
...
usertext = '*\n ⇜اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'SOURCE_FAWAZ')..')'
status  = '\n *⇜تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevFAWAZW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⇜اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_FAWAZ')..')'
status  = '\n*⇜تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevFAWAZW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevFAWAZW(msg) then
...
local FAWAZ1_Msg = database:get(bot_id.."FAWAZ1:Add:Filter:Rp2"..text..msg.chat_id_)   
if FAWAZ1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⇜اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_FAWAZ')..') \n ⇜'..FAWAZ1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if FAWAZ_Msg and not Special(msg) then  
local FAWAZ_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if FAWAZ_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⇜العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⇜["..FAWAZ_Msg.."] \n")
else
send(msg.chat_id_,0," *⇜العضو :* {["..data.first_name_.."](T.ME/SOURCE_FAWAZ)}\n⇜["..FAWAZ_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⇜عذرا ↫* {["..data.first_name_.."](T.ME/SOURCE_FAWAZ)}\n*⇜عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevFAWAZW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevFAWAZW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevFAWAZW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⇜حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevFAWAZW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⇜حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⇜" and DevFAWAZW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⇜تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⇜$") and DevFAWAZW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⇜حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⇜" and DevFAWAZW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⇜" and DevFAWAZW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⇜تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⇜" and DevFAWAZW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."FAWAZ:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."FAWAZ:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_FAWAZ = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_FAWAZ then 
names_FAWAZ = database:smembers(bot_id.."FAWAZ:blocname"..msg.chat_id_) or ""
if names_FAWAZ and names_FAWAZ[1] then 
for i=1,#names_FAWAZ do 
if name_FAWAZ:match("(.*)("..names_FAWAZ[i]..")(.*)") then 
...
database:set(bot_id.."FAWAZ:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."FAWAZ:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."FAWAZ:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."FAWAZ:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."FAWAZ:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_FAWAZa_new(FAWAZ1,FAWAZ2)
if FAWAZ2 and FAWAZ2.first_name_ then 
if FAWAZ2.first_name_:match("(.*)"..database:get(bot_id.."FAWAZ:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."FAWAZ:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local FAWAZ_nnn = database:get(bot_id.."FAWAZ:nump"..msg.chat_id_) or 5
local FAWAZ_nnn2 = database:get(bot_id.."FAWAZ:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(FAWAZ_nnn2) == tonumber(FAWAZ_nnn) or tonumber(FAWAZ_nnn2) > tonumber(FAWAZ_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."FAWAZ:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⇜عزيزي >>["..FAWAZ2.username_.."](https://t.me/"..(FAWAZ2.username_ or "SOURCE_FAWAZ")..")\n⇜عليك وضع التوحيد ⪼ {"..database:get(bot_id.."FAWAZ:teh"..msg.chat_id_).."} بجانب اسمك\n⇜عدد المحاولات المتبقيه {"..(tonumber(FAWAZ_nnn) - tonumber(FAWAZ_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_FAWAZa_new)
end
end
...
local FAWAZChengName = database:get(bot_id.."FAWAZ:Cheng:Name"..data.id_)
if not data.first_name_ then 
if FAWAZChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..FAWAZChengName..']')
database:del(bot_id.."FAWAZ:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if FAWAZChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."FAWAZ:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local FAWAZChengUserName = database:get(bot_id.."FAWAZ:Cheng:UserName"..data.id_)
if not data.username_ then 
if FAWAZChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..FAWAZChengUserName..']')
database:del(bot_id.."FAWAZ:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if FAWAZChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."FAWAZ:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local FAWAZChengPhoto = database:get(bot_id.."FAWAZ:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if FAWAZChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."FAWAZ:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if FAWAZChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."FAWAZ:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('https://FAWAZ-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'✫: شترك في قناة السورس اولآ @wtttw .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ مطور السورس\n\n[-  ғᴀᴡᴀᴢ ᴄʜᴀɴɴᴇʟ  .](http://t.me/wtttw)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/SOURCE_FAWAZ)\n\n[-  ғᴀᴡᴀᴢ ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/wtttw)\n\n[-  ʙᴏᴛ ғᴀᴡᴀᴢ](http://t.me/mh5bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ғᴀᴡᴀᴢ sᴏᴜʀᴄʀ .',url="t.me/wtttw/567"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/wtttw&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevFAWAZW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*⇜بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_FAWAZ')..') \n*⇜تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⇜بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE_FAWAZ')..') \n*⇜تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevFAWAZW(msg) then
dofile('FAWAZ.lua')  
send(msg.chat_id_, msg.id_, ' *⇜تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevFAWAZW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevFAWAZW(msg) then  
function start_function(extra, result, success)
if FAWAZSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevFAWAZW(msg) then  
...
if FAWAZSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⇜لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevFAWAZW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if FAWAZSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⇜لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevFAWAZW(msg) then  
function start_function(extra, result, success)
if FAWAZSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⇜لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevFAWAZW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevFAWAZW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if FAWAZSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⇜لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevFAWAZW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevFAWAZW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevFAWAZW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevFAWAZW(msg) then
...
if text == 'الملفات' and DevFAWAZW(msg) then
...
if DevFAWAZW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/FAWAZ-DeV/Files_FAWAZ/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⇜اهلا بك في متجر ملفات بويكا*\n*⇜ملفات السورس ↓*\n*- - - - - - - - - - - - - -*\n\n"
local TextE = "\n*- - - - - - - - - - - - - -*\n *⇜علامة تعني { ✓ } ملف مفعل*\n *⇜علامة تعني { ✘ } ملف معطل*\n *⇜قناة سورس بويكا ↓*\n".." *⇜*[اضغط هنا لدخول](t.me/SOURCE_FAWAZ) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevFAWAZW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/FAWAZ-DeV/Files_FAWAZ/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevFAWAZW(msg) then
...
if text == "مسح الملفات" and DevFAWAZW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⇜تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevFAWAZW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevFAWAZW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "SOURCE_FAWAZ")
...
function Function_FAWAZ(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_FAWAZ, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_FAWAZ, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⇜العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_FAWAZ')..')'
status  = '\n*⇜تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⇜لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_FAWAZ')..')'
status  = '\n*⇜تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⇜اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⇜العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_FAWAZ')..')'
...
database:set(bot_id.."FAWAZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."FAWAZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⇜ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."FAWAZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."FAWAZ1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."FAWAZ1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."FAWAZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⇜تم منع الكلمه مع التحذير*")  
database:del(bot_id.."FAWAZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."FAWAZ1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."FAWAZ1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."FAWAZ1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⇜ارسل الكلمه الان*")  
database:set(bot_id.."FAWAZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."FAWAZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."FAWAZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FAWAZ1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."FAWAZ1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."FAWAZ1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."FAWAZ1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FAWAZ1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."FAWAZ1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevFAWAZW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⇜تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevFAWAZW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⇜اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_FAWAZ')..')'..'\n*⇜تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevFAWAZW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevFAWAZW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..FAWAZ_Msg[math.random(#FAWAZ_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevFAWAZW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,FAWAZ)
local t = "\n*ツ قائمة الاعضاء* \n*- - - - - - - - - - - - - -*\n"
x = 0
local list = FAWAZ.members_
for k, v in pairs(list) do
x = x + 1
...
if FAWAZSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevFAWAZW(msg) then 
...
if text == ("ردود المطور") and DevFAWAZW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⇜قائمة ردود المطور \n*- - - - - - - - - - - - - -*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevFAWAZW(msg) then    
send(msg.chat_id_, msg.id_,' *⇜ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevFAWAZW(msg) then    
...
if text == 'تفعيل المغادره' and DevFAWAZW(msg) then   
...
if text == 'تعطيل المغادره' and DevFAWAZW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⇜العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'wtttw')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_FAWAZ')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
FAWAZdx(msg.chat_id_, msg.id_, ' *⇜ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⇜عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⇜عدد المحظورين » ( '..data.kicked_count_..' )*\n*⇜عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevFAWAZW(msg) then
...
{{text = 'الالعاب', callback_data="/help4"},{text = 'التسليه', callback_data="/help5"}},
{{text = 'مطور السورس', url="t.me/WTTTW"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://FAWAZ-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⇜قائمه الزخرفه* \nٴ⇜∫ٴ*- - - - - - - - - - - - - -*ٴ⇜∫○ٴ \n"
i = 0
...
gk = https.request('https://FAWAZ-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://FAWAZ-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://FAWAZ-api.ml/audios.php')
if res == 200 then
...
{{text = '~ FAWAZ •',url='http://t.me/wtttw'}},
}
...
https.request("https://FAWAZ-api.ml/Do/searchinbot.php?V="..URL.escape(id_from_vid).."&ch=do")
end
end
...
https.request("https://FAWAZ-api.ml/Do/searchinbot.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
end
Ok_id  = DAata:match("(%d+)")  
...
⇜ اضف رد عشوائي ↢ عشان تضيف اكثر من رد
⇜ مسح الردود العشوائيه ↢ عشان تمسح رد عشوائي
⇜ الردود العشوائيه ↢ تشوف الردود المضافه
⇜ اضف رد ↢ عشان تضيف رد
...
inline = {
{{text = 'مطور السورس',url='http://t.me/wtttw'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فواز')
...
FAWAZ = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(FAWAZ)
...
--------------------------------------------------------------------------------------------------------------
SourceFAWAZ(data.message_,data)
...
------------------------------------------------------------------------
local FAWAZAbot = database:get(bot_id.."FAWAZ1:Add:Filter:Rp2"..text..result.chat_id_)   
if FAWAZAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⇜العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⇜["..FAWAZAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local FAWAZ1_Msg = database:get(bot_id.."FAWAZ1:Add:Filter:Rp2"..text..result.chat_id_)   
if FAWAZ1_Msg then
send(msg.chat_id_, msg.id_," ⇜"..FAWAZ1_Msg)
